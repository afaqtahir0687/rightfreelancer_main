...
class JobProposal extends Model
{
    ...
    protected $fillable = ['job_id','freelancer_id','client_id','amount', 'freelancer_service_fee', 'you_receive_amount', 'duration','revision','cover_letter','attachment','status','is_hired','is_short_listed','is_interview_take','load_from',
        'is_synced'];
