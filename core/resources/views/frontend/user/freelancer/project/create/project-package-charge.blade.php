            ...
            <div class="package-table">
                <table class="table table-bordered table-responsive create_project_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="package-field">
                                <textarea class="form-control" name="basic_details" id="basic_details" rows="3" placeholder="{{ __('Enter details for Basic package') }}"></textarea>
                            </div>
                        </td>
                        <td>
                            <div class="package-field">
                                <textarea class="form-control disabled_or_not" name="standard_details" id="standard_details" rows="3" placeholder="{{ __('Enter details for Standard package') }}"></textarea>
                            </div>
                        </td>
                        <td>
                            <div class="package-field">
                                <textarea class="form-control disabled_or_not" name="premium_details" id="premium_details" rows="3" placeholder="{{ __('Enter details for Premium package') }}"></textarea>
                            </div>
                        </td>
                    </tr>
