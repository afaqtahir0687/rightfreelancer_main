            ...
            <div class="package-table">
                ...
                <table class="table table-bordered table-responsive create_project_table">
                    ...
                    <tr>
                        <th>
                            <div class="package-head-left">
                                <span class="package-head-left-title">{{ __('Details') }}</span>
                            </div>
                        </th>
                        <td>
                            <textarea class="form-control" name="basic_details" id="basic_details" rows="3" placeholder="{{ __('Enter details for Basic package') }}">{{ $project_details->basic_details ?? '' }}</textarea>
                        </td>
                        <td>
                            <textarea class="form-control disabled_or_not" name="standard_details" id="standard_details" rows="3" placeholder="{{ __('Enter details for Standard package') }}">{{ $project_details->standard_details ?? '' }}</textarea>
                        </td>
                        <td>
                            <textarea class="form-control disabled_or_not" name="premium_details" id="premium_details" rows="3" placeholder="{{ __('Enter details for Premium package') }}">{{ $project_details->premium_details ?? '' }}</textarea>
                        </td>
                    </tr>
