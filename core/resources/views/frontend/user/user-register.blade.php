            ...
            <div class="choose-account center-text">
                ...
                <div class="choose-account-flex d-flex mt-4">
                    <div class="choose-account-single selected join_as_a_freelancer">
                       ...
                       <h6 class="choose-account-single-contents-title mt-3">
                            {!! get_static_option('register_page_choose_join_freelancer_title') ?? __('Join as a freelancer,<br>looking for work') !!}
                        </h6>
                    ...
                    <div class="choose-account-single join_as_a_client">
                      ...
                      <div class="choose-account-single-contents mt-3">
                        <h6 class="choose-account-single-contents-title">
                            {!! get_static_option('register_page_choose_join_client_title') ?? __('Join as a Client,<br>hiring for a project') !!}
                        </h6>
                      </div>
                                        ...
                                        <div class="login-others">
                                            <div class="login-others-single">
                                                <a href="{{ route('login.google.redirect') }}" class="login-others-single-btn w-100">
                                                    ...
                                                    <span class="login-para"> {{ __('Sign Up With Google') }} </span>
                                                </a>
                                            </div>
                                            <div class="login-others-single">
                                                <a href="{{ route('login.facebook.redirect') }}" class="login-others-single-btn w-100">
                                                    <i class="fa-brands fa-facebook"></i>
                                                    <span class="login-para"> {{ __('Sign Up With Facebook') }} </span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
