...
@section('site_title', __('About Us'))

@section('meta_title') {{ __('About Us - Right Freelancer | Global Freelancing Platform') }}@endsection
                ...
                <div class="col-xxl-4 col-lg-4">
                    <div class="about-wrapper-right">
                        <div class="about-wrapper-thumb">
                            <div class="about-wrapper-thumb-item position-relative" style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#aboutVideoModal" data-video="https://www.youtube.com/embed/3XUTzdMLVqg?autoplay=1">
                                <img src="https://www.rightfreelancer.com/assets/frontend/img/rightfreelancer_tutorial.png" alt="" class="img-fluid" style="display:block; margin:auto; border-radius:10px;"/>
            ...
            <div class="row g-4 mt-4">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="aboutWhat-wrapper">
                        <div class="aboutWhat-wrapper-thumb position-relative" style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#aboutVideoModal" data-video="https://www.youtube.com/embed/3XUTzdMLVqg?autoplay=1">
                            <img src="assets/frontend/img/rightfreelancer_tutorial.png" alt="" class="img-fluid" style="display:block; margin:auto;"/>
                            <span class="aboutWhat-wrapper-icon about-video video_play" style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:48px;color:white;background:rgba(0,0,0,0.5);border-radius:50%;padding:20px;">
                                <i class="fa-solid fa-play"></i>
                            </span>
                        </div>
                        ...
                        <div class="slider-item">
                            <div class="aboutTeam-item">
                                <div class="aboutTeam-item-thumb">
                                    <img src="https://www.rightfreelancer.com/assets/frontend/img/fazal.jpg" alt="" />
                                </div>
                                <div class="aboutTeam-item-contents mt-3">
                                    <h6 class="aboutTeam-item-title">Md Siam Ahmed</h6>
                                    <p class="aboutTeam-item-para">Webflow Developer</p>
                                </div>
                            </div>
                        </div>
                        <div class="slider-item">
                            <div class="aboutTeam-item">
                                ...
                                <div class="aboutTeam-item-contents mt-3">
                                    <h6 class="aboutTeam-item-title">Mohammad Shahin</h6>
                                    <p class="aboutTeam-item-para">Web Designer</p>
                                </div>
                            </div>
                        </div>
                        <div class="slider-item">
                            <div class="aboutTeam-item">
                                ...
                                <div class="aboutTeam-item-contents mt-3">
                                    <h6 class="aboutTeam-item-title">Nazmul Hoque</h6>
                                    <p class="aboutTeam-item-para">Developer</p>
                                </div>
                            </div>
                        </div>
                        <div class="slider-item">
                            <div class="aboutTeam-item">
                                ...
                                <div class="aboutTeam-item-contents mt-3">
                                    <h6 class="aboutTeam-item-title">Md Riyad Hossain</h6>
                                    <p class="aboutTeam-item-para">Html Developer</p>
                                </div>
                            </div>
                        </div>
                        <div class="slider-item">
                            <div class="aboutTeam-item">
                                ...
                                <div class="aboutTeam-item-contents mt-3">
                                    <h6 class="aboutTeam-item-title">Md Zahid Hasan</h6>
                                    <p class="aboutTeam-item-para">Developer</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content bg-transparent border-0 shadow-none">
          ...
          <div class="modal-body p-0" style="display:flex; align-items:center; justify-content:center; min-height:60vh;">
            <div class="ratio ratio-16x9 w-100">
              <iframe id="aboutVideoIframe" src="" title="YouTube video" allowfullscreen allow="autoplay" style="border-radius:12px;"></iframe>
            </div>
          </div>
        </div>
      </div>
